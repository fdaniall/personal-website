...
import { Cpu, Globe, Rocket, Terminal, BookOpen, Briefcase, LucideIcon } from "lucide-react";
...
const TimelineItem = ({ role, company, period, description }: TimelineItemProps) => (
            ...
            <div className="container mx-auto">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="md:col-span-2">
                        <BentoCard className="h-full min-h-[300px]" icon={Terminal} title="Profile">
                            ...
                            <p className="text-gray-400 leading-relaxed text-lg mb-6">
                                ...
                                <br /><br />
                                Passionate about <span className="text-accent">Web3</span> and Blockchain infrastructure.
                                My recent project, <span className="font-bold italic" style={{ color: '#CCFF00' }}>Vultara</span>—a smart vault on Base for automated ETH yield strategies—secured <span className="text-white font-medium">3rd Place at the Base Indonesia Hackathon 2025</span>.
                            </p>
                    ...
                    <motion.div variants={itemVariants} className="md:col-span-1">
                        <BentoCard title="Tech Stack" className="h-full" icon={Cpu}>
                    ...
                    {/* Education */}
                    <motion.div variants={itemVariants} className="md:col-span-1">
                        <BentoCard title="Education" className="h-full" icon={BookOpen}>
                            <div className="mt-2">
                    ...
                    <motion.div variants={itemVariants} className="md:col-span-2 row-span-2">
                        <BentoCard icon={Briefcase} title="Experience" className="h-full">
                            <div className="mt-4">
                                <TimelineItem
                    ...
                    {/* Location */}
                    <motion.div variants={itemVariants} className="md:col-span-1">
                        <BentoCard className="h-full bg-gradient-to-br from-blue-900/20 to-purple-900/20" icon={Globe}>
